...
class Maverick(nn.Module):
    ...
    OPTION 2: Architecture includes LLM action as feature
    Input: 23 Maverick features + 6 LLM action one-hot = 29 features
    '''
    def __init__(self):
        super(Maverick, self).__init__()

        self.input_size = 29  # 23 Maverick + 6 LLM one-hot
