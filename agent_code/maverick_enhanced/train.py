...
SAVE = 'lightweight_training'  # New lightweight model
...
# Experience Replay: Moderate buffer for faster training
BUFFERSIZE = 5000   # Reduced from 10000 for faster sampling
BATCH_SIZE = 128    # Reduced from 256 for faster gradient computation

LOSS_FUNCTION = nn.MSELoss()
OPTIMIZER = optim.Adam
LEARNING_RATE = 0.001   # Increased for faster learning (was 0.0005)

# Training episodes: Reduced for faster iteration
TRAINING_EPISODES = 10000  # Reduced from 50000 for faster training cycles
