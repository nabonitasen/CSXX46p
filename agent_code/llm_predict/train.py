"""
Training callbacks for LLM Predict agent - for evaluation metrics tracking only.

The LLM Predict agent doesn't learn from rewards (it uses Claude API for decisions),
...
def setup_training(self):
    """
    Setup for LLM Predict agent evaluation tracking.

    LLM doesn't train/learn, but we track metrics for evaluation.
    """
    self.name = "LLM Predict"
    ...
    self.logger.info("LLM Predict evaluation tracking initialized.")
