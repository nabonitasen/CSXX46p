...
def initialize_rule_based(self):
    ...
    Updated to 26 features (added 3 new safety features)

    :param self: This object is passed to all callbacks and you can set arbitrary values.
    '''
    self.action_array = np.zeros((6,26))
    # coins
    ...
    # === NEW SAFETY FEATURES (23, 24, 25) ===
    # Feature 23: Escape urgency - penalize all actions when in danger
    self.action_array[0][23] = -50
    self.action_array[1][23] = -50
    self.action_array[2][23] = -50
    self.action_array[3][23] = -50
    self.action_array[4][23] = -50  # WAIT also bad when urgent
    self.action_array[5][23] = -100 # BOMB is worst when already in danger

    # Feature 24: Safe zone access - reward movement actions that have good access
    self.action_array[0][24] = 150
    self.action_array[1][24] = 150
    self.action_array[2][24] = 150
    self.action_array[3][24] = 150
    self.action_array[4][24] = 50   # WAIT is okay if we have good access

    # Feature 25: Survival probability - heavily weight this for all actions
    self.action_array[0][25] = 200
    self.action_array[1][25] = 200
    self.action_array[2][25] = 200
    self.action_array[3][25] = 200
    self.action_array[4][25] = 100
    self.action_array[5][25] = -50  # Don't bomb if survival is already questionable