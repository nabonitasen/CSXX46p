...
SAVE = 'maverick_enhanced_v2'  # Original architecture (26->60->6) with 3 new safety features
...
# Experience Replay: Larger buffer for more diverse experiences (matching original maverick)
BUFFERSIZE = 10000  # Increased from 3000 to match original maverick
BATCH_SIZE = 256    # Increased from 64 to match original maverick for stable gradients

LOSS_FUNCTION = nn.MSELoss()
OPTIMIZER = optim.Adam
LEARNING_RATE = 0.0005  # Lower learning rate for more stable learning (matching original maverick)

# Training episodes: Increased for more thorough learning
TRAINING_EPISODES = 50000  # Increased from 10000 to match original maverick
